...
public class ModelFactoryNGTest {
    ...
    public void testGetModelsWithoutModelOption() throws InvalidInputException {
        ...
        assertEquals(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).size(), 9);
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof GOModelImpl);
    }
    ...
    public void testGetModelsWithModelOption() throws InvalidInputException {
        ...
        assertEquals(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).size(), 0);
        
        when(cmdl.getOptionValues(OPT_MODELS)).thenReturn(new String[]{"go"});
        assertEquals(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).size(), 1);
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof GOModelImpl);
    }
    ...
    public void testGetModelsWithModelOptionButIncorrectModelName() throws Exception {
        ...
        ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(), new RLinearModelGoodnessOfFitTest(null), argsParser);
    }
    ...
    public void testGetModelsWithGOSModelOption() throws InvalidInputException {
        ...
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof GOSShapedModelImpl);
    }
    ...
    public void testGetModelsWithMOModelOption() throws InvalidInputException {
        ...
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof MusaOkumotoModelImpl);
    }
    ...
    public void testGetModelsWithDUModelOption() throws InvalidInputException {
        ...
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof DuaneModelImpl);
    }
    ...
    public void testGetModelsWithHDModelOption() throws InvalidInputException {
        ...
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof HossainDahiyaModelImpl);
    }
    ...
    public void testGetModelsWithWEModelOption() throws InvalidInputException {
        ...
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof WeibullModelImpl);
    }
    ...
    public void testGetModelsWithYEModelOption() throws InvalidInputException {
        ...
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof YamadaExponentialModelImpl);
    }
    ...
    public void testGetModelsWithYRModelOption() throws InvalidInputException {
        ...
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof YamadaRaleighModelImpl);
    }
    ...
    public void testGetModelsWithLLModelOption() throws InvalidInputException {
        ...
        assertTrue(ModelFactory.getModels(new ArrayList<>(), new ArrayList<>(),
                new RLinearModelGoodnessOfFitTest(null), argsParser).get(0) instanceof LogLogisticModelImpl);
    }
