...
/**
 * Log-Logistic model least squares solver implementation.
 *
...
public class LogLogisticLeastSquaresSolver extends SolverAbstract {
   ...
   */
  public LogLogisticLeastSquaresSolver(Rengine rEngine, RJriExceptionHandler handler) {
  ...
  protected String buildStartParametersDataFrame() {
    return "a = c(10, 10000), b = c(0.001, 10), c = c(0.001, 10)";
  }
