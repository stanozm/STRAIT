...
/**
 * Duane model least squares solver implementation.
 *
...
public class DuaneLeastSquaresSolver extends SolverAbstract {
   ...
   */
  public DuaneLeastSquaresSolver(Rengine rEngine, RJriExceptionHandler handler) {
  ...
  protected String buildStartParametersDataFrame() {
    return "a = c(0.00001, 500), b = c(0.00001, 100)";
  }
