...
/**
 * Yamada Exponential model least squares solver implementation.
 *
...
public class YamadaExponentialLeastSquaresSolver extends SolverAbstract {
   ...
   */
  public YamadaExponentialLeastSquaresSolver(Rengine rEngine, RJriExceptionHandler handler) {
  ...
  protected String buildStartParametersDataFrame() {
    return "a = c(100, 100000), b = c(0.00001, 1), c = c(0.001, 10)";
  }
