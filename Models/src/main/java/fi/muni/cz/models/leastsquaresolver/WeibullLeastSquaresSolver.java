...
/**
 * Weibull model least squares solver implementation.
 *
...
public class WeibullLeastSquaresSolver extends SolverAbstract {
   ...
   */
  public WeibullLeastSquaresSolver(Rengine rEngine, RJriExceptionHandler handler) {
  ...
  protected String buildStartParametersDataFrame() {
    return "a = c(100, 10000), b = c(0.00001, 1), c = c(1, 10)";
  }
