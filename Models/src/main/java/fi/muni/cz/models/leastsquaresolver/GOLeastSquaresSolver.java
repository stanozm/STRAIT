...
/**
 * GO model least squares solver implementation.
 *
...
public class GOLeastSquaresSolver extends SolverAbstract {
   ...
   */
  public GOLeastSquaresSolver(Rengine rEngine, RJriExceptionHandler handler) {
  ...
  protected String buildStartParametersDataFrame() {
    return "a = c(10, 200000), b = c(0.00001, 10)";
  }
