...
/**
 * Remove GeneralIssue objects that have a creation date before the publish date of the first release
 *
...
public class FilterOutIssuesBeforeFirstRelease implements Filter {
    ...
    public List<GeneralIssue> apply(List<GeneralIssue> list, RepositoryInformation repositoryInformation) {
        ...
        Set<GeneralIssue> filteredList = new HashSet<>(new FilterByTime(firstReleasePublishDate, now)
