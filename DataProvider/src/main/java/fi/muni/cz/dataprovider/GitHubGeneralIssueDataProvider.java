...
public class GitHubGeneralIssueDataProvider implements GeneralIssueDataProvider {
  ...
  public List<GeneralIssue> getIssuesByUrl(String urlString) {
    ...
    return getIssuesByOwnerRepoName(parsedUrlData.getUserName(), parsedUrlData.getRepositoryName());
  }
  ...
  private List<GeneralIssue> getIssuesByOwnerRepoName(String owner, String repositoryName) {
    ...
    try {
      ...
      throw new AuthenticationException(
          "Bad credenrials set. " + "Wrong name or password in authentication file.", ex);
  ...
  private List<GeneralIssue> getAllGeneralIssues(String owner, String repositoryName)
      throws IOException {
    return beanMapping.mapTo(getClosedAndOpenedIssues(owner, repositoryName), GeneralIssue.class);
  }

  private List<Issue> getClosedAndOpenedIssues(String owner, String repositoryName)
      throws IOException {
